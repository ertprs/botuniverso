...
const wait = async (media) => new Promise(async (resolve, reject) => {
    ...
    try {
    	...
    	let belief = () => similarity < 0.89 ? "*Eu tenho pouca fé nisso* 🐦\n *Galera a maioria dos animes vai sair errada e se sair hentai quem deu o comando vai levar ban* : " : ""
...
const banner = cfonts.render(('Nan|Nan'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","yellow"],
